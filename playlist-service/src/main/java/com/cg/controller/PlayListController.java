...
public class PlayListController {
	...
	@PostMapping("/add")
	public PlayList addToPlayList(@RequestBody PlayList PlayList) throws PlayListAlreadyExistException {
	...
	@GetMapping("/find/{id}")
	public PlayListForResponse findPlayListWithIds(@PathVariable long id)  throws PlayListNotFoundException{
